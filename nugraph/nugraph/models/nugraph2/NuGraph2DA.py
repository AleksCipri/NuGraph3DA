...
from ...data import H5DataModuleDAnew
...
class NuGraph2(LightningModule):
    ...
    def training_step(self,
                      batch,
                      batch_idx: int) -> float:
        self.step(batch) #should I separate them here or just make a decoderDA that does everything. I use total loss here, but I need to add logging of MMD too
        total_loss = 0.
        for decoder in self.decoders:
